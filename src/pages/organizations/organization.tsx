              ...
              <div className='col-span-1 lg:col-span-3 p-4 pt-0'>
                <CardHeader className='p-0'>
                  <div className='flex flex-row justify-start items-center'>
                    <CardTitle className='text-2xl font-bold'>Infinite Education Network</CardTitle>
                    <Button variant="scale_btn" size="scale_btn" className='bg-cyan-500/25 text-cyan-500 ml-4 '>
                      <svg className='inline-block mr-2' xmlns="http://www.w3.org/2000/svg" width="8" height="8" viewBox="0 0 24 24">
                  ...
                  <CardDescription className='text-muted-foreground/60 pt-3'>Joined on 27-03-2024 20:14 PM</CardDescription>
                </CardHeader>
              </div>
              <div className='col-span-1 lg:col-span-3 p-4 pt-0 flex sm:justify-start lg:justify-end items-center sm:pt-0'>
                <Button className='px-2 hidden md:block'>
