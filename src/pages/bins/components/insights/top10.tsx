            ...
            <Table>
                ...
                <TableHeader className="bg-background">
                    <TableRow>
                        ...
                        <TableHead className="text-right">WASTE ACCUMULATION (LAST 07 DAYS)</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                    {tops.map((invoice) => (
                        <TableRow key={invoice.rank}>
                            <TableCell >
                                <div className={`font-medium w-fit px-2 py-1 rounded-xl  ${invoice.rank === "1" ? "bg-primary" : invoice.rank === "2" ? "bg-primary/70" : invoice.rank === "3" ? "bg-primary/60" : "bg-background"}`}>#{invoice.rank}</div>
                            </TableCell>
                            <TableCell>
