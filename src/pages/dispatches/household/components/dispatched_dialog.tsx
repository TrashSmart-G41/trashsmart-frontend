...
import { fetchDispatch, deleteDispatch } from '/Users/mashawickramasinghe/Desktop/UCSC/3rd Year/Group Project 2/trashsmart-frontend/src/pages/dispatches/household/data/services.tsx'
          ...
          <>
            ...
            <div className='gap-y-4'>
              ...
              <Card className='my-2 p-4'>
                <div className='grid grid-cols-3'>
                  <div className='col-span-2 grid'>
                    <div className='text-[12px] text-muted-foreground'>Truck ID</div>
                    <div className='text-sm font-medium text-muted-foreground'>
                      TRK003
                    </div>
                  </div>
              ...
              <Card className='p-4'>
                <div className='grid grid-cols-3'>
                  <div className='col-span-2 grid'>
                    <div className='text-[12px] text-muted-foreground'>Driver ID</div>
                    <div className='text-sm font-medium text-muted-foreground'>
                      EMP10005
                    </div>
                  </div>
