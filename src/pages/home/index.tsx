...
export default function Index() {
  ...
  return (
    <>
      <Nav />
      {/* End Nav */}
      <div className='container pt-24  lg:pt-24 '>
        {/* Grid */}
        <div className='grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20'>
          <div>
            <h1 className='scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl'>
              <span className='text-primary'>TrashSmart:</span> A vision for
              sustainability.
            </h1>
            <p className='mt-3 text-lg text-muted-foreground'>
              At TrashSmart, we revolutionize waste management by blending
              innovation with practicality. Our system uses advanced sensors and
              data analytics to transform conventional waste handling into an
              efficient, technology-driven process, turning visions of
        ...
        <div className='mt-0 flex items-center gap-x-1.5 py-3 text-sm text-muted-foreground after:ms-6 after:flex-[1_1_0%] after:border-t after:border-t-muted-foreground/50 md:mt-12'>
          Trusted by organizations, institutes, and more than{' '}
          <span className='bg-gradient-to-l bg-clip-text font-semibold text-primary'>
            100
          </span>{' '}
          of you
        </div>
        <div className='flex w-full flex-wrap items-center justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24'>
          {/*<svg*/}
          ...
          {/*</svg>*/}
          <img
            src="src/pages/home/assets/image1.png"
            alt="Logo"
            className="block dark:hidden h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image1d.png"
            alt="Logo"
            className="hidden dark:block h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image2.png"
            alt="Logo"
            className="block dark:hidden h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image2d.png"
            alt="Logo"
            className="hidden dark:block h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image3.png"
            alt="Logo"
            className="block dark:hidden h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image3d.png"
            alt="Logo"
            className="hidden dark:block h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image4.png"
            alt="Logo"
            className="block dark:hidden h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image4d.png"
            alt="Logo"
            className="hidden dark:block h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image5.png"
            alt="Logo"
            className="block dark:hidden h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image5d.png"
            alt="Logo"
            className="hidden dark:block h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image6.png"
            alt="Logo"
            className="block dark:hidden h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
          <img
            src="src/pages/home/assets/image6d.png"
            alt="Logo"
            className="hidden dark:block h-auto w-16 py-3 md:w-20 lg:w-24 lg:py-5"
          />
        </div>
