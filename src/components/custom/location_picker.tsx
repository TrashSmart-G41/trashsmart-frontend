  ...
  return (
    <div className={`${className} relative`} style={{ width, height }}>
      <div
        ...
        className='absolute right-4 top-4 z-10 rounded shadow-lg'
      />
      <Map
      ...
      {selectedLocation && (
        <div className='absolute bottom-4 left-4 z-10 rounded bg-white p-4 shadow-lg transition-all'>
      ...
      <button
        onClick={logLocation}
        className='absolute bottom-4 right-4 z-10 rounded bg-blue-500 p-2 text-white shadow-lg hover:bg-blue-600'
      >
        Log Location
      </button>
    </div>
