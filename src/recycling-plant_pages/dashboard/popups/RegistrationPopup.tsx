          ...
          <Card className='my-2 p-4'>
              <div className='grid grid-cols-3'>
                  <div className='col-span-2 grid'>
                      ...
                      <div className='text-sm font-medium text-muted-foreground'>{auction}</div>
                  </div>
              </div>
          </Card>
          <Card className='my-2 p-4'>
              <div className='grid grid-cols-3'>
                  <div className='col-span-2 grid'>
                      <div className='text-[12px] text-muted-foreground'>Waste Type</div>
                      <div className='text-sm font-medium text-muted-foreground'>{wasteType}</div>
                  </div>
              </div>
          </Card>
          <Card className='my-2 p-4'>
